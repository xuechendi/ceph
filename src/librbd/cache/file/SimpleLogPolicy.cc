...
template <typename I>
int SimpleLogPolicy<I>::get_writeback_block(uint64_t *block) {
  CephContext *cct = m_image_ctx.cct;
...
template <typename I>
int SimpleLogPolicy<I>::map(IOType io_type, uint64_t block, bool partial_block,
